...
#: The captured Java-side JSON for GET /api/v1/taxpayers/taxpayer-001. Generated by serialising
#: the real `TaxpayerReadModel` class through Jackson with Spring Boot's date settings.
